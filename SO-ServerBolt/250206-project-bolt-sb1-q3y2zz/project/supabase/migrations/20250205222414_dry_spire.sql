/*
  # Create unitCombat function
  
  1. New Function
    - Takes match_id, gamePieceId, and position coordinates
    - Validates unit positions and types
    - Calculates combat damage using multipliers
*/
...
BEGIN
    ...
    IF v_health_type IS NULL THEN
        RAISE EXCEPTION 'No health type found for defender unit type %', v_defender_piece.type_num;
    END IF;
